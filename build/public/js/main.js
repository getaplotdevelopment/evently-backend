...
const chatForm = document.getElementById('chat-form'); // const leaveForum = document.getElementById('leave-forum');

const feedback = document.querySelector('.outputFeedback');
const chatMessages = document.querySelector('.chat-messages');
const roomName = document.getElementById('room-name');
const userList = document.getElementById('users');
let timeout; // Get username and room from URL
...
chatForm.addEventListener('submit', e => {
  ...
  const msg = e.target.elements.msg.value; // Emit a message to the server

  forumSocket.emit('MESSAGE_CHAT_FORUM', msg); // Clear input
