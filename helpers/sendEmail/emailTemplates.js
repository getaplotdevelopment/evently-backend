...
const emailTemplates = {
  resetPassword: {
    ...
    <a style="background-color: #61a46e; padding: 12px 15px 12px; color: #eee; font-size: 16px; text-decoration:none; margin-left:20px; cursor: pointer" href="${url}/api/reset-password/$token"> Reset Password </a>`
  },
  verification: {
    from: '',
    to: '',
